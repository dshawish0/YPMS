                            ...
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <%{
                                    ...
                                    if (currentMonth == Calendar.JANUARY) {
                                        ...
                                        out.print(" <div>\n" +
                                                "                                    <a href=\"Goal\" class=\"btn btn-primary; disabled\" >New Goal</a>\n" +
                                                "                                </div>");
                                    }
                                }%>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <% List<goal> goals = (ArrayList<goal>)request.getAttribute("goals");
                                        for(goal goal : goals) {
                                            ...
                                            out.print("<td>"+goal.getDate()+"</td>");
                                            out.print("<td >\n" +
                                                    "<form method=\"POST\">"+
                                                    "<input type=\"text\" name=\"id\" value="+goal.getGoalId()+" hidden>"+
                                                    "      <input type=\"submit\" class=\"btn btn-danger\" style=\"display:flex; justify-content: center\" value=\"delete\"'/'> " +
                                                    "  </td >\n" +
                                                    "</tr >\n"+
                                                    "</form>");
                                            out.print("</td>");
