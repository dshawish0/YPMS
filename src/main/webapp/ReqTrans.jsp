...
<%@ page import="com.example.ypms.DTO.EmpTrans" %><%--
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" >
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center" scope="col">old Dep</th>
                                        <th class="text-center" scope="col">new Dep</th>
                                        <th class="text-center" scope="col">Status</th>
                                        <th scope="col">View</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <% List<EmpTrans> empTrans = (ArrayList<EmpTrans>)request.getAttribute("empTrans");
                                        for(EmpTrans emp : empTrans) {
                                            if(!emp.getStatus().equals("Accepted")) {
                                                ...
                                                if(emp.getOldDep().equals("1"))
                                                    out.print("<td>" + "Human Resources" + "</td>");
                                                else if(emp.getOldDep().equals("2"))
                                                    out.print("<td>" + "Accounting" + "</td>");
                                                else if(emp.getOldDep().equals("3"))
                                                    out.print("<td>" + "Engineering" + "</td>");
                                                else if(emp.getOldDep().equals("4"))
                                                    out.print("<td>" + "Sales and Marketing" + "</td>");

                                                out.print("<td>" + emp.getNewDep() + "</td>");
...
//                                                    out.print("</td>");
                                                    ...
                                                    out.print("<td >\n" +
                                                            "<form method=\"POST\">" +
                                                            "<input type=\"text\" name=\"transId\" value=" + emp.getTransferId() + " hidden>" +
                                                            "<input type=\"text\" name=\"empId\" value=" + emp.getEmpId() + " hidden>" +
                                                            "<input type=\"text\" name=\"NewDep\" value=" + emp.getNewDep() + " hidden>" +
