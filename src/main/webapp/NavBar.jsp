  ...
  <div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
      ...
      <ul class="list-unstyled menu-categories" id="accordionExample">
        <li href="JanGoals" class="menu">
          <a href="JanGoals" aria-expanded="false" class="dropdown-toggle">
            <div class="">
              ...
              <span href="JanGoals">January Goals</span>
            </div>
          </a>
        </li>

        <li class="menu">
          <a href="NovAchievements" aria-expanded="false" class="dropdown-toggle">
            <div class="">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart">
                <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
              </svg>
              <span href="NovAchievements">November Achievements</span>
            </div>
          </a>
        </li>
        ...
        <li href="applyTransfer" class="menu">
          <a href="applyTransfer" aria-expanded="false" class="dropdown-toggle">
            <div class="">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart">
                <path d="M21.21 15.89A10 10 0 1 1 8 2.83"></path>
                <path d="M22 12A10 10 0 0 0 12 2v10z"></path>
              </svg>
              <span href="applyTransfer">Apply-transfer</span>
            </div>
          </a>
        </li>
      </ul>
