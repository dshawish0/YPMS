...
<%@ page import="com.example.ypms.model.transfer" %><%--
          ...
          <div class="statbox widget box box-shadow">
            <div class="widget-header p-4">
              <div class="d-flex flex-row justify-content-between">
                <div>
                  <h4>Apply-transfer</h4>
                </div>
                <div>
                  <a href="Transfer" class="btn btn-primary">Apply-transfer</a>
                </div>
              </div>
            </div>
                ...
                <table class="table table-bordered">
                  ...
                  <% List<transfer> transfers = (ArrayList<transfer>)request.getAttribute("transfers");
                    for(transfer trans : transfers) {
                      out.print("<tr>");
                      out.print("<td>"+trans.getTransferId()+"</td>");
                      out.print("<td>");
                      out.print(trans.getNewDep()+"</td>");
                      out.print("<td>"+trans.getEmpMesg()+"</td>");
                      if(trans.getStatus().equals("inProcessing")){
                        out.print("<td class=\"text-center\"><span class=\"badge badge-light-info\">In Progress</span>");
                        out.print("</td>");
                      }
                      else if(trans.getStatus().equals("Draft")){
                        out.print("<td class=\"text-center\"><span class=\"badge badge-light-danger\">Draft</span>");
                        out.print("</td>");
                        out.print("<td><button onclick=\"openPopup(\'"+trans.getManegerMesg()+"\')\" class=\"btn-link\">view</button></td>");
                      }
                      else{
